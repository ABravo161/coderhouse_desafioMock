...
public class MessageControllerTest {
    ...
    @Test
    public void getMensajesString() throws Exception {
    ...
    public void getMensajesByDescription() throws Exception {
        var result = mockMvc.perform(get("/coder-house/mensajes").param("description","Mensaje-ABCF"))
                .andDo(print())
                .andExpect(content().string(containsString("Mensaje-ABCF")));
    }
